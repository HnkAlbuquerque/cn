...
if (mb_eregi("db.php",$_SERVER["PHP_SELF"])) {
    Header("Location: /");
    die();
}

$the_include = "{$_SERVER["DOCUMENT_ROOT"]}/db";
...
if(!$db->db_connect_id) {
    die("<br><br><center><img src=images/logo.png><br><br><b>There seems to be a problem with the <i>$dbtype</i> server database, sorry for the inconvenience.<br><br>We should be back shortly.</center></b>");
}
