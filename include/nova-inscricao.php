...
?>
  <div class="form-group">
     <div class="row">
        <div class="col-sm-12">
          <h3>Realizar nova inscrição para <?=$infoEvento['ev_nome']?></h3>
        </div>
                                ...
                                $.getJSON(
                                  ...
                                  function( json )
                                  {
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        if (globalJ[0] == 3)
                                                                        {
                                                                            alert("Membro já está inscrito para este evento!");
                                                                        }
                                                                        else
                                                                        {
...
<div id="non-printable"> 
  ...
  <form method="post" onsubmit="return finalizaSubmit();">
    ...
    <div class="row">
          ...
          <div class="col-md-12"> 
            <div class="col-md-3"> 
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalMembro">Inscrever Membro</button>
            </div>
            <div class="col-md-3"> 
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalVis">Inscrever Visitante</button>
            </div>
            <div class="col-md-3"> 
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalTeen">Inscrever Crianças/Jovens </button>
            </div>
            
            <div class="col-md-3"> 
                  <button type='button' class='btn btn-danger' onclick='window.location.reload();'>Apagar Ficha </button>
            </div>
          </div> 
         ...
         <table align="center" cellspacing="5">
            <tr>             
              <td>
                        ...
                        formaction='index.php?page=finalizar'> - CONCLUIR INSCRIÇÃO - </button>
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="form-group">
                                          <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                              <input type="text" id="nomeVis" maxlength="60" class="form-control">
                                            </div>
                                          </div>     
                                      </div>
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="form-group">
                                          <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                              <input type="text" id="idadeChild" name="idadeChild" maxlength="2" class="form-control" size="3" onkeypress="return isNumber(event)">
                                            </div>
                                          </div>     
                                      </div>
                                      ...
                                      <div class="form-group">
                                          <div class="row">
                                            ...
                                            <div class="col-md-5">
                                              <input type="text" id="aliasChild" maxlength="30" class="form-control my-form-control">
                                            </div>
                                          </div>     
                                      </div>
                                      <hr>
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                      ...
                                      <div class="form-group">
                                          <div class="row">
                                            <div class="col-sm-4">
                                              <input type="text" maxlength="60" class="form-control" size="38" name="buscaMembro" id="buscaMembro">
                                            </div>
                                            <div class="col-sm-4">
