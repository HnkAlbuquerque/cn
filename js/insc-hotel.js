 function adicionaLinha()
      ...
      var conjvalue = document.getElementById('conjS').checked;
            ...
            if ( teste > 5)
            {
             ...
             // var cell5 = row.insertCell(5);
              ...
              if (document.getElementById('as_tipo').value == 'G')
              {
                ...
                ins3.setAttribute("onclick","Jantar("+insnum+");");
                ins3.setAttribute('checked',true);
                ins3.setAttribute('disabled',true);
            ...
            /*    var ins5 = document.createElement("input");
             ...
             /*   var ins4 = document.createElement("input");
                ...
                ins4.setAttribute("onclick","Almoco("+insnum+");");
                            ...
                            cell4.appendChild(valAlm);

                
                cell4.appendChild(ins4);*/
                ...
                cell1.appendChild(valA);
                 ...
                 /* var trans = document.createElement("input");
                    ...
                    trans.setAttribute("onclick","Transporte("+insnum+");");
              ...
              if (conjvalue == true && teste2 > 6 )
              {
                    ...
                    //  var cell55 = row2.insertCell(5);
                      ...
                      but.setAttribute("onclick","deleteRow(this.parentNode.parentNode.rowIndex);");
                    ...
                    /* TRANSPORTE  
                      ...
                      trans2.setAttribute("onclick","Transporte("+insnum+");");
             ...
             /*   var ins4 = document.createElement("input");
                ...
                cell4.appendChild(ins4);
                    ...
                    /*  var transV = document.createElement("input");
                      ...
                      transV.setAttribute("onclick","Transporte("+insnum+");");
  ...
  function adicionaChild()
  {
     ...
     var teste2 = document.getElementById('idadeChild').value;
           ...
           //   var cell5 = row.insertCell(5);
              ...
              if (document.getElementById("insIdade_"+insnum).value > 3)
              {
                var valC = document.createElement("input");
                valC.type = "hidden";
                valC.setAttribute("value","120");
  ...
  function finalizaSubmit()
  {
    ...
    var linesPG = document.getElementById('linesPG').value
    if (linhasTabela < 2 || linesPG < 1)
    {
      if (linhasTabela < 2 && linesPG < 1)
      {
        ...
        return false;
            ...
            {
              alert('Você precisa adicionar uma forma de pagamento para finalizar');
              return false;
            }
            else
            {
              alert('Você precisa adicionar alguém na ficha de inscrição para finalizar');
              return false;
            }
    }
    else
  ...
  function somaAll()
  {
    ...
    document.getElementById("valorTotal").value = (vrIns+vrJan+vrAlm+vrTrans);
  }